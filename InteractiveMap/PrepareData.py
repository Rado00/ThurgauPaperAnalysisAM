...
municipalities_gdf['area_km2'] = municipalities_gdf['geometry'].area / 1e6  # Convert area to square kilometers
municipalities_gdf['population_density'] = municipalities_gdf['population_count'] / municipalities_gdf['area_km2']  # people/km²
